...
{
    static  TCHAR   szHeader[] = TEXT("AudioE2E: ");
    TCHAR   szBuffer[1024];
...
SHELLPROCAPI ShellProc(UINT uMsg, SPPARAM spParam)
{
    ...
    case SPM_BEGIN_GROUP:
        ...
        g_pKato->BeginLevel(0, TEXT("BEGIN GROUP: AudioE2E.DLL"));
        break;
    ...
    case SPM_END_GROUP:
        ...
        g_pKato->EndLevel(TEXT("END GROUP: AudioE2E.DLL"));
        break;
