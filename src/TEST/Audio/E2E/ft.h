...
BEGIN_FTE
    FTH(0, "Audio and file system E2E test")
    FTE(1,      "Audio playing and file system (SD) E2E test"  , 1001, 0, AudioPlay_E2E)
    FTE(1,      "Audio recording and file system (SD) E2E test", 1002, 0, AudioRec_E2E)
END_FTE
