...
BEGIN_FTE
    FTH(0, "JPEG and file system E2E test")
    FTE(1,      "JPEG and file system (NAND) E2E test", 1001, 0, JpegFileSystemNAND_E2E)
    FTE(1,      "JPEG and file system (USB Mass Storage) E2E test", 1002, 0, JpegFileSystemUSB_E2E)
    FTE(1,      "JPEG and file system (SD Card) E2E test", 1003, 0, JpegFileSystemSD_E2E)
END_FTE
