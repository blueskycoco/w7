...
BEGIN_FTE
    ...
    FTE(1,      "JPEG Decompress test", 1001, 0, JPEGDec)
    FTE(1,      "JPEG Compress test", 1002, 0, JPEGCom)
    FTH(0, "STREAM DRIVER INTERFACE TEST")
    FTE(1,      "JPEG Basic Stream I/F test", 1101, 0, JPEGStream)
    FTE(1,      "JPEG Decompress IO control test", 1102, 0, JPEGIOCtlDec)
    FTE(1,      "JPEG Compress IO control test", 1103, 0, JPEGIOCtlEnc)
    FTH(0, "TRANSFER PERFORMANCE TEST")
    FTE(1,      "JPEG Compress performance test", 1301, 0, JPEGComPerf)
    FTE(1,      "JPEG Decompress performance test", 1302, 0, JPEGDecPerf)
    FTH(0, "BOUNDARY CONDITION TEST")
    //FTE(1,        "JPEG Oversize Compress test", 1501, 0, JPEGOverCom)
    FTE(1,      "JPEG Oversize Decompress test", 1502, 0, JPEGOverDec)
    //FTE(1,        "JPEG Exact size Compress/Decompress test", 1503, 0, JPEGExactCodec)
    //FTE(1,        "JPEG Small Compress/Decompress test", 1504, 0, JPEGSmallCodec)
    //FTE(1,        "JPEG Odd Compress test", 1505, 0, JPEGOddCom)
    FTE(1,      "JPEG Odd Decompress test", 1506, 0, JPEGOddDec)
END_FTE
