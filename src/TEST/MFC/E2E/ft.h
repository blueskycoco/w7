...
BEGIN_FTE
    FTH(0, "MFC and file system E2E test")
    FTE(1,      "MFC H.264 and NAND flash E2E test", 1001, 0, MFC_H264_NAND_E2E)
    FTE(1,      "MFC H.263 and USB Mass Storage E2E test", 1002, 0, MFC_H263_USB_E2E)
    FTE(1,      "MFC MPEG4 and SD card E2E test", 1003, 0, MFC_MPEG4_SD_E2E)
    FTE(1,      "MFC VC1 and SD card E2E test", 1004, 0, MFC_VC1_SD_E2E)
END_FTE
