...
BEGIN_FTE
    FTH(0, "Power Management basic function verify")
    FTE(1,      "Basic function verify", 1001, 0, PMTUX_DevicePowerStateVerify)
    FTH(0, "Power Management API verify")
    FTE(1,      "API test", 1401, 0, PMTUX_PowerRequirementVerify)
END_FTE
