...
#define PWBTESTS(x) PROPERTY_BASEID + x
////////////////////////////////////////////////////////////////////////////////
// TUX Function table
...
BEGIN_FTE
    FTH(0, "power button test cases")
    FTE(1,      "1: Test power button trig suspend event", PWBTESTS(1), 0, PWBTUX_SuspendCheck)
    FTE(1,      "2: Test power button trig resume event", PWBTESTS(2), 0, PWBTUX_ResumeCheck)
    FTE(1,      "3: Test PowerManagement API StopPowerNotifications", PWBTESTS(3), 0, PWBTUX_CheckStopPowerNotification)
END_FTE
